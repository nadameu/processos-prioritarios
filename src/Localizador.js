...
let promiseFormularioRelatorioGeral = null;
function obterFormularioRelatorioGeral() {
	if (! promiseFormularioRelatorioGeral) {
		promiseFormularioRelatorioGeral = new Promise((resolve, reject) => {
	...
	return promiseFormularioRelatorioGeral;
}

export default class Localizador {
	constructor() {
		this.id = null;
		this.linha = null;
		this.link = null;
